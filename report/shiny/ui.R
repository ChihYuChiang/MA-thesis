...
ui <- fluidPage(#--Header
        ...
        sidebarLayout(
          sidebarPanel(width=3,
                ...
                sliderInput("filter_1", NULL, step=0.01, min=1, max=7, value=c(1, 7)),
                tags$p(tags$b(FILTER$F2_1), code(FILTER$F2_2), br(), FILTER$F2_3),
                sliderInput("filter_2", NULL, step=0.01, min=1, max=7, value=c(1, 7)),
                tags$p(tags$b(FILTER$F3_1), code(FILTER$F3_2), br(), FILTER$F3_3),
                sliderInput("filter_3", NULL, step=0.01, min=1, max=7, value=c(1, 7)),
                tags$p(tags$b(FILTER$F4_1), code(FILTER$F4_2), br(), FILTER$F4_3),
                sliderInput("filter_4", NULL, step=0.01, min=1, max=7, value=c(1, 7)),
                tags$p(tags$b(FILTER$F5_1), code(FILTER$F5_2), br(), FILTER$F5_3),
                sliderInput("filter_5", NULL, step=0.01, min=1, max=7, value=c(1, 7)),
                tags$p(id="obs",
